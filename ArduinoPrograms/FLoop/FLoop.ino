...
double onThresh = -4;        //temperature threshold to turn on this mechanism. (on state)
double badThresh = 2;       //temperature threshold to signal that something bad is happening(bad state)
